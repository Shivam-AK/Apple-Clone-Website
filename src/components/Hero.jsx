    ...
    return (
        <section className='w-full nav-height relative bg-black'>
            <div className='h-5/6 w-full flex-center flex-col'>
                ...
                <div className='xl:w-[90%] lg:w-[80%] md:w-[75%] sm:w-[40%] xs:w-[90%] w-[90%] z-[11] '>
                    <video className='pointer-events-none z-[11] ' autoPlay muted loop playsInline={true} key={videoSrc} >
